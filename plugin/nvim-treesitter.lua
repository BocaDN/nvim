...
if not has_treesitter_cli then
  vim.schedule(function()
    vim.notify("tree-sitter CLI not found; nvim-treesitter auto-install disabled. Install it and run :TSInstall python", vim.log.levels.WARN)
  end)
end
...
require("nvim-treesitter").setup({
	...
	auto_install = has_treesitter_cli,
